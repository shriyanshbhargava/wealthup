...
export const HouseGoal: React.FC<{
  ...
  <DialogContent className="p-6">
    <DialogHeader>
      <DialogTitle className="text-center text-2xl">Investment</DialogTitle>
    </DialogHeader>
        ...
        <form className="md:w-full w-[90%]" onSubmit={handleSubmit}>
          <div className="flex flex-col mb-4 mt-6 gap-2 w-full">
            ...
            <div className="bg-white rounded-full w-full">
              <input type="month" min={date} name="date" defaultValue={date} className="bg-white rounded-full p-4 text-2xl text-brand-blue font-bold h-[67px] w-full" />
            </div>
          </div>
