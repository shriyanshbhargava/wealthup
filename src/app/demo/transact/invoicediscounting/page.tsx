                                    ...
                                    {allDeals?.length === 0 ? (
                                        ...
                                        <div>
                                            ...
                                            <div className="flex justify-between">
                                                <p className='text-white text-base sm:text-[6px] md:text-[1.25rem] bg-green-800 w-fit py-2 px-4 my-2 md:my-5 rounded-full font-semibold'>Invoice Discounting</p>
                                                {
                                                    remainingDeals?.length === 0 &&
                                                    <Link href='/myaccount/onboarding' className='text-white text-base sm:text-[6px] md:text-[1.25rem] bg-[#FF7300] w-fit py-2 px-4 my-2 md:my-5 rounded-full font-semibold'>Complete Your KYC</Link>
                                                }
                                            </div>
